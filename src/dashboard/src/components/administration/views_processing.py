...
def index(request):
    ...
    chain_choice_fields = [
        ...
        },
        {
            ...
            "uuid": "e0a39199-c62a-4a2f-98de-e9d1116460a8"
        }
    ]
        ...
        for choice in choices:
            ...
            for field in select_fields:
                if applies_to == field['choice_uuid'] and go_to_chain:
                    try:
                        choice =lookup_chain(go_to_chain).description
...
def lookup_chain(chain_uuid):
    return models.MicroServiceChain.objects.get(pk=chain_uuid)
